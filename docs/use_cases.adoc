...
| [source,yaml]
----
include::../tests/assets/uc_single_value_string.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_single_value_integer.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_random_choice.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_single_value_object.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_multi_value_string.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_static_ref_events.yaml[]
----
| [source, console]
----
...
| [source, yaml]
----
include::../tests/assets/uc_static_ref_random_start.yaml[]
----
...
| [source,yaml]
----
include::../tests/assets/uc_seq_format_string.yaml[]
----
| [source,console]
----
...
| [source,yaml]
----
include::../tests/assets/uc_cond_status_change.yaml[]
----
| [source,console]
----
